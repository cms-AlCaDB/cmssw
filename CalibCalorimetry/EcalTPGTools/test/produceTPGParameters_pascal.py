...
process.TPGParamProducer = cms.EDFilter("EcalTPGParamBuilder",
    ...
    outFile = cms.string('TPG_beamv3_pascal.txt'), #modif
   #### TPG config tag and version (if not given it will be automatically given ) ####
    TPGtag = cms.string('BEAMV3FORSFGVB'),
   ...
   #### TPG calculation parameters ####
    ...
    LUT_option = cms.string('EcalResolution'),       ## compressed LUT option can be: "Identity", "Linear", "EcalResolution"
    ...
    LUT_stochastic_EB = cms.double(0.028),    ## Stochastic term of the ECAL-EB ET resolution (used only if LUT_option="EcalResolution")
    LUT_noise_EB = cms.double(0.125),          ## noise term (GeV) of the ECAL-EB ET resolution (used only if LUT_option="EcalResolution")
    LUT_constant_EB = cms.double(0.003),     ## constant term of the ECAL-EB ET resolution (used only if LUT_option="EcalResolution")
    LUT_stochastic_EE = cms.double(0.028),    ## Stochastic term of the ECAL-EE ET resolution (used only if LUT_option="EcalResolution")
    LUT_noise_EE = cms.double(0.125),          ## noise term (GeV) of the ECAL-EE ET resolution (used only if LUT_option="EcalResolution")
    LUT_constant_EE = cms.double(0.003),     ## constant term of the ECAL-EE ET resolution (used only if LUT_option="EcalResolution")
