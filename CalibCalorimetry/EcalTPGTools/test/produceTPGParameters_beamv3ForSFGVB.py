...
process.source = cms.Source("EmptySource",
           ...
           firstRun = cms.untracked.uint32(147065) ### need to use latest run to pick-up update values from DB 
)
...
##process.TPGParamProducer = cms.EDFilter("EcalTPGParamBuilder", ##modif
process.TPGParamProducer = cms.EDAnalyzer("EcalTPGParamBuilder",
    ...
    ##outFile = cms.string('TPG_beamv3_sFGVB.txt'), #modif
    outFile = cms.string('TPG_beamv3_sFGVB_emul_17.txt'), #modif
   ...
   #### TPG calculation parameters ####
    ...
    SFGVB_Threshold = cms.uint32(17),        ## used with option forcedPedestalValue = -3
