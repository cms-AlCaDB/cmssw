...
process.TPGParamProducer = cms.EDAnalyzer("EcalTPGParamBuilder",
    ...
    outFile = cms.string('TPG_beamv5_MC_startup.txt'), #modif
   #### TPG config tag and version (if not given it will be automatically given ) ####
    TPGtag = cms.string('BEAMV5MCSTARTUP'),
   ...
   #### TPG calculation parameters ####
    ...
    SFGVB_SpikeKillingThreshold = cms.int32(8),   ## (GeV) Spike killing threshold applied in TPG ET in TCC
