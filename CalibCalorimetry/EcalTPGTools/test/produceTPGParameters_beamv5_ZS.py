...
process.TPGParamProducer = cms.EDAnalyzer("EcalTPGParamBuilder",
   ...
   #### TPG calculation parameters ####
    ...
    SFGVB_Threshold = cms.uint32(9),              ## (adc) SFGVB threshold in FE
    ...
    TTF_lowThreshold_EE = cms.double(0.5),  ## EE Trigger Tower Flag low threshold in GeV
    TTF_highThreshold_EE = cms.double(0.5),  ## EE Trigger Tower Flag high threshold in GeV
