...
process.ecalTPConditions = cms.ESSource("PoolDBESSource",
	...
	#cms.PSet(
        ...
        #    tag = cms.string('EcalTPGCrystalStatus_beamv5_test_mc')
        #),
	#cms.PSet(
        #    record = cms.string('EcalTPGTowerStatusRcd'),
        #    tag = cms.string('EcalTPGTowerStatus_beamv5_test_mc')
        #)
	),
    messagelevel = cms.untracked.uint32(3),
    timetype = cms.string('runnumber'),
#    connect = cms.string('oracle://ecalh4db/TEST02'),
#    connect = cms.string('sqlite_file:../../../CalibCalorimetry/EcalTPGTools/test/DB_beamv5_ideal_mc.db'),
