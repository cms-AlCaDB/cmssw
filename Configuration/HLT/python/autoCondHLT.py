...
#   'symbolic GT'            : ('base GT',[('payload1',payload2')])
    ...
    'run1_hlt_Fake'          : ('hlt'            ,l1Menus['Fake']),
    'run2_hlt_Fake'          : ('hlt_relval'     ,l1Menus['Fake']),
    'run2_hlt_Fake1'         : ('hlt_relval'     ,l1Menus['Fake1']),
    'run2_hlt_FULL'          : ('hlt_relval'     ,l1Menus['FULL']),
    'run2_hlt_GRun'          : ('hlt_relval'     ,l1Menus['GRun']),
    'run2_hlt_HIon'          : ('hlt_hi'         ,l1Menus['HIon']),
    'run2_hlt_PIon'          : ('hlt_relval'     ,l1Menus['PIon']),
    'run2_hlt_PRef'          : ('hlt_relval'     ,l1Menus['PRef']),

    'run1_data_Fake'         : ('data'           ,l1Menus['Fake']),
    'run2_data_Fake'         : ('data_relval'    ,l1Menus['Fake']),
    'run2_data_Fake1'        : ('data_relval'    ,l1Menus['Fake1']),
    'run2_data_FULL'         : ('data_relval'    ,l1Menus['FULL']),
    'run2_data_GRun'         : ('data_relval'    ,l1Menus['GRun']),
    'run2_data_HIon'         : ('data'           ,l1Menus['HIon']),
    'run2_data_PIon'         : ('data_relval'    ,l1Menus['PIon']),
    'run2_data_PRef'         : ('data_relval'    ,l1Menus['PRef']),
