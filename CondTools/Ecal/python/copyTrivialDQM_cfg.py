    ...
    timetype = cms.untracked.string('runnumber'),
      toPut = cms.VPSet(
        cms.PSet(
            ...
            tag = cms.string('EcalDQMTowerStatus_mc')
        ),
        cms.PSet(
            record = cms.string('EcalDQMChannelStatusRcd'),
            tag = cms.string('EcalDQMChannelStatus_mc')
        )
      )
)
...
process.dbCopy = cms.EDAnalyzer("EcalDBCopy",
    timetype = cms.string('runnumber'),
       toCopy = cms.VPSet( 
         cms.PSet(
            record = cms.string('EcalDQMTowerStatusRcd'),
            container = cms.string('EcalDQMTowerStatus')
         ),
         cms.PSet(
            record = cms.string('EcalDQMChannelStatusRcd'),
            container = cms.string('EcalDQMChannelStatus')
         )
        )
)
